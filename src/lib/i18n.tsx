...
const en: Dict = {
  ...
  "champions.about.body": "Every month a different champion holds the season. Win matches in any mode to earn Cup points. At the end of the month, the top player receives a personal invitation to meet that season's champion. Format, date and location are agreed individually with the winner.",
...
const ru: Dict = {
  ...
  "champions.about.body": "Каждый месяц сезон Кубка ведёт новый чемпион. Побеждай в любом режиме, чтобы копить очки. В конце месяца игрок, набравший больше всех, получает личное приглашение встретиться с чемпионом сезона. Формат, дата и место согласуются индивидуально.",
...
const kk: Dict = {
  ...
  "champions.about.body": "Әр айда Кубок маусымын жаңа чемпион басқарады. Кез келген режимде жеңіп, ұпай жинаңыз. Ай соңында ең көп ұпай жинаған ойыншы сезон чемпионымен жеке кездесуге шақырылады. Пішімі, күні мен орны жеке келісіледі.",
